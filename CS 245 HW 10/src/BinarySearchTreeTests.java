...
class BinarySearchTreeTests {
	...
	public void testFields() {
		assertEquals("BinarySearchTree should only have \"root\", \"first\", and \"numElements\" fields", BinarySearchTree.class.getDeclaredFields().length, 3);
	}
	...
	public void testConstructor() {
		try {
			...
			assertNull("BinarySearchTree constructor is not working correctly", first.get(bst));
	...
	public void testClear() {
		try {
			...
			assertNull("clear method is not working correctly", first.get(bst));
		} catch (Exception e) {
	...
	public void testAdd() {
		try {
			...
			for(int i=0; i<100; ++i) {
				...
				assertTrue("add method is not working correctly", isLinkedBST(root.get(bst)));
	...
	public void testRemove() {
		try {
			...
			while(itr.hasNext()) {
				...
				assertTrue("remove method is not working correctly", isLinkedBST(root.get(bst)));
	...
	public void testBalance() {
		try {
			...
			bst.balance();
			sun(myBst);
			assertTrue("balance method is not working correctly", isBalanced(root.get(bst)));
			assertTrue("remove method is not working correctly", isLinkedBST(root.get(bst)));
			assertTrue("balance method is not working correctly", equalBSTs(myBst, bst));
		} catch (Exception e) {
